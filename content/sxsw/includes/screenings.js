...
function screeningsLiveSearchInit() {
...
function screeningsLiveSearchStart() {
	if (t) {
		window.clearTimeout(t);
	}
	t = window.setTimeout("screeningsliveSearchDoSearch()",200);
}

function screeningsliveSearchDoSearch() {
	...
	liveSearchReq.open("GET", "/includes/screenings.livesearch.php?q=" + document.forms.searchform.sxswq.value);

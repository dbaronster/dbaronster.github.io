...
<html:html xhtml="true">
	...
	<body <%=printing?"":"background=\"images/background.jpg\""%> >
		...
		<% if (printing) { %>
			<div><html:img src="images/gridiron.jpg" style="float:left"/></div>
		...
		<% } else { %>
			...
			%>
				<p>
					...
					<span class="name"><%=recruit.getMetric("firstName").getValue()%> <%=recruit.getMetric("lastName").getValue()%></span>
